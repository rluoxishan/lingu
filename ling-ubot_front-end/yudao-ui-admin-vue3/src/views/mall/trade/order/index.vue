<template>
  ...
  <OrderUpdateRefundForm ref="updateRefundForm" @success="getList" />
</template>
...
import OrderUpdateRefundForm from '@/views/mall/trade/order/form/OrderUpdateRefundForm.vue'
...
const handleCommand = (command: string, row: TradeOrderApi.OrderVO) => {
  switch (command) {
    ...
    case 'delivery':
      ...
      break
    case 'refund':
      updateRefundForm.value?.open(row)
      break
  }
}
