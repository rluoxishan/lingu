...
const remainingRouter: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'business',
        component: () => import('@/views/urv/business/index.vue'),
        name: 'Business',
        meta: {
          title: t('view.urv.business.title'),
          icon: 'ep:briefcase',
          noCache: false
        }
      },
      {
        path: 'group',
        component: () => import('@/views/urv/group/index.vue'),
        name: 'Group',
        meta: {
          title: t('view.urv.group.title'),
          icon: 'ep:paperclip',
          noCache: false
        }
      },
      {
        path: 'vehicle',
        component: () => import('@/views/urv/vehicle/index.vue'),
        name: 'Vehicle',
        meta: {
          title: t('view.urv.vehicle.title'),
          icon: 'ep:van',
          noCache: false
        }
      },
      {
        path: 'mission',
        component: () => import('@/views/urv/mission/index.vue'),
        name: 'Mission',
        meta: {
          title: t('view.urv.mission.title'),
          icon: 'ep:flag',
          noCache: false
        }
      },
      {
        path: 'error',
        component: () => import('@/views/urv/error/index.vue'),
        name: 'Error',
        meta: {
          title: t('view.urv.error.title'),
