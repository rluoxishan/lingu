...
import type { CloudDeviceBatchItem, CameraStreamItem, DeviceDetailData, DeviceInstructionBody, DevicePageItem, DevicePageData, TaskListItem } from './types'
...
export const VehicleApi = {
  ...
  selectDeviceDetail: async (deviceId: string): Promise<DeviceDetailData> => {
    ...
    return unwrapCloudPayload<DeviceDetailData>(res) ?? {}
