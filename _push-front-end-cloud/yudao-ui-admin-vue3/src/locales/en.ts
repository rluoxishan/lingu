export default {
  common: {
    ...
    updated: 'Updated',
    secs_ago: '{ durationInSeconds }s ago',
    actions: 'Actions'
  },
  lock: {
  ...
  form: {
    ...
    remark: 'Remark',
    prompt_enter: 'Enter { field }.',
    exception_empty: '{ field } cannot be empty!',
    btn_submit: 'Submit',
    btn_cancel: 'Cancel',
    btn_actions: 'Actions',
  },
  ...
  map: {
    focus: 'Focus Vehicle',
    error: {
      loading: 'Error loading AMap: { error }.',
      markerInitialization: 'Marker is not initialized.',
    },
  },
  view: {
    urv: {
      ...
      vehicle: {
        ...
        error: {
          loading: 'Loading vehicle viewer is not possible.',
        },
      },
      error: {
        title: 'Error',
    ...
    mall: {
      home: {
        yesterdayData: 'Yesterday\'s Data',
        memberStatistics: 'User Statistics',
        numberOfRegistrations: 'Registrations',
        operationDataCard: 'Operational Data',
        undeliveredOrders: 'Undelivered Orders',
        ordersInRefundProcess: 'Orders in Refund Process',
        ordersPendingVerification: 'Pending Orders Verification',
        stockAlert: 'Stock Alert',
        listedProducts: 'Listed Products',
        warehouseProducts: 'Warehouse Products',
        withdrawalsPendingReview: 'Pending Withdrawals Review',
