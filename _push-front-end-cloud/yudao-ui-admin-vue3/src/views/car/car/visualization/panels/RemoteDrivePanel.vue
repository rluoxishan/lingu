      ...
      <div class="remote-drive__bottom">
        <div class="remote-drive__tank">
          <div class="remote-drive__tank-row">
            <span>水箱</span>
            <div class="remote-drive__bar"><div class="remote-drive__bar-fill" :style="{ width: waterLevel + '%' }"></div></div>
            <span>{{ waterLevel }}%</span>
          </div>
          <div class="remote-drive__tank-row">
            <span>垃圾箱</span>
            <div class="remote-drive__bar"><div class="remote-drive__bar-fill remote-drive__bar-fill--warn" :style="{ width: wasteLevel + '%' }"></div></div>
