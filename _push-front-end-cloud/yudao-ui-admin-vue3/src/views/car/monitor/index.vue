  ...
  <div class="monitor-page">
    ...
    <div class="monitor-page__telemetry">
      ...
      <div class="monitor-page__live">
        ...
        <span class="monitor-page__live-dot" :class="{ 'monitor-page__live-dot--off': !liveTelemetry }"></span>
...
import { createMonitorMockState, tickMonitorMock } from '../car/visualization/mockMonitor'
...
import PlotPanel from '../car/visualization/panels/PlotPanel.vue'
...
import StatePanel from '../car/visualization/panels/StatePanel.vue'

import VideoPanel from '../car/visualization/panels/VideoPanel.vue'

import type { CameraKey, MonitorControlMode, MonitorMockState } from '../car/visualization/types'
