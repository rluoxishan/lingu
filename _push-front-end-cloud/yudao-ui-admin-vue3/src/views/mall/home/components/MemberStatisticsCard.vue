<template>
  <el-card shadow="never">
    <template #header>
      <CardTitle :title="t('view.mall.home.memberStatistics')" />
    </template>
    <!-- 折线图 -->
...
const lineChartOptions = reactive<EChartsOption>({
  ...
  series: [{ name: t('view.mall.home.numberOfRegistrations'), type: 'line', smooth: true, areaStyle: {} }],
  toolbox: {
    feature: {
      // 数据区域缩放
      dataZoom: {
      ...
      saveAsImage: { show: true, name: t('view.mall.home.memberStatistics') } // 保存为图片
    }
  },
  tooltip: {
    trigger: 'axis',
