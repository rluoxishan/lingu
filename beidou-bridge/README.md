...
> **现场主教程（MQTT·无外网）**：**[docs/中转机离线部署手册-MQTT模式.md](./docs/中转机离线部署手册-MQTT模式.md)**  
> **真北斗验收**：**[docs/现场安装与真北斗联调教程.md](./docs/现场安装与真北斗联调教程.md)**  
> **现场速查**：**[docs/明天到现场操作手册.md](./docs/明天到现场操作手册.md)**  
> **现场部署（完整）**：**[docs/现场部署清单.md](./docs/现场部署清单.md)**  
...
**无外网现场（5G + 车端 MQTT 直连中转，`dataSource: mqtt`）**

```
车端+5G ──MQTT 1010001──► 中转机(EMQX+bridge) ──HTTP内网──► 北斗系统
```

详见 **[docs/方案变更-5G车端MQTT直连中转.md](./docs/方案变更-5G车端MQTT直连中转.md)**。
...
| 文档 | 用途 |
|------|------|
| **[中转机离线部署手册-MQTT模式](./docs/中转机离线部署手册-MQTT模式.md)** | **中转机无外网：U盘物料+逐步安装** |
| [MQTT联调实验室-双机测试](./docs/MQTT联调实验室-双机测试.md) | **5G 电脑模拟车 + 双机联调** |
| [方案变更-5G车端MQTT直连中转](./docs/方案变更-5G车端MQTT直连中转.md) | 无外网架构说明 |
